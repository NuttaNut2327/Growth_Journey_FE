...
class LikedBlogsCard extends StatefulWidget {
  const LikedBlogsCard({super.key});

  @override
  State<LikedBlogsCard> createState() => _LikedBlogsCardState();
}

class _LikedBlogsCardState extends State<LikedBlogsCard> {
  ...
  Future<void> loadRecentBlog() async {
    ...
    try {
      final blogs = await repo.getLikedBlogs();
      if (!mounted) return;
